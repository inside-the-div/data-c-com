...
<div class="row">
	<div class="col-12 text-right">
		...
		<a data-toggle="tooltip" data-placement="top" title="All Users" href="{{route('admin.user.add')}}" class="btn btn-dark  ">
...
<form action="{{route('admin.user.store')}}" method="post" id="user_add_form">
	...
	<div class="row mt-20">
		<div class="col-12 col-lg-6 offset-lg-3 mb-3">
			<div class="card p-3 rounded-0">
				...
				<input required  type="password" class="form-control rounded-0 mb-2" name="password">
				...
				<textarea required  maxlength="400"  id="description" cols="30" rows="3" name="description" class="form-control mb-2"></textarea>
		...
		<div class="col-12 col-lg-4 mb-2">
			<div class="card p-3 rounded-0">
				...
				<div class="row mt-3">
					...
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input product-permission" id="product-store" value="admin.product.store">
					...
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input product-permission" id="product-edit" value="admin.product.edit">
		...
		<div class="col-12 col-lg-4 mb-2">
			<div class="card p-3 rounded-0">
				...
				<div class="row mt-3">
					...
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input category-permission" id="category-edit" value="admin.category.edit">
			...
			<div class="card p-3 rounded-0">
				...
				<div class="permission-title title-border">
					<div class="row">
						<div class="col-12 col-lg-6">
							<div class="toggleCheck chk3 d-inline">
								<input type="checkbox" name="permission[]" id="sliders"  value="admin.sliders">
								<label for="sliders">
									<div class="toggleCheck_switch" data-checked="Yes" data-unchecked="No"></div>
								</label>
							</div>
				...
				<div class="row mt-3">
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input slider-permission" id="slider-show" value="admin.slider.show">
							<label class="custom-control-label font-18 font-pt" for="slider-show">Show</label>
						</div>
					</div>
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input slider-permission" id="slider-add"  value="admin.slider.add">
					...
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input slider-permission" id="slider-edit" value="admin.slider.active">
							<label class="custom-control-label font-18 font-pt" for="slider-edit">Active</label>
						</div>
					</div>
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input slider-permission" id="slider-delete" value="admin.slider.delete">
			...
			<div class="card p-3 rounded-0">
				...
				<div class="permission-title title-border">
					<div class="row">
						<div class="col-12 col-lg-6">
							<div class="toggleCheck chk3 d-inline">
								<input type="checkbox"  id="faqs" name="permission[]" value="admin.faqs">
								<label for="faqs">
									<div class="toggleCheck_switch" data-checked="Yes" data-unchecked="No"></div>
								</label>
							</div>
				...
				<div class="row mt-3">
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input faq-permission" id="faq-show" value="admin.faq.show">
							<label class="custom-control-label font-18 font-pt" for="faq-show">Show</label>
						</div>
					</div>
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input faq-permission" id="faq-add" value="admin.faq.add">
					...
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input faq-permission" id="faq-edit" value="admin.faq.edit">
							<label class="custom-control-label font-18 font-pt" for="faq-edit">Edit</label>
						</div>
					</div>
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input faq-permission" id="faq-delete" value="admin.faq.delete">
		...
		<div class="col-12 col-lg-4 mb-2">
			<div class="card p-3 rounded-0">
				...
				<div class="row mt-3">
					...
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input coupon-permission" id="coupon-store" value="admin.coupon.store">
					...
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input coupon-permission" id="coupon-edit" value="admin.coupon.edit">
		...
		<div class="col-12 col-lg-4 mb-2">
			<div class="card p-3 rounded-0">
				...
				<div class="row mt-3">
					...
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input order-permission" id="order-edit" value="admin.order.update">
			...
			<div class="card p-3 rounded-0">
				...
				<div class="permission-title title-border">
					<div class="row">
						<div class="col-12 col-lg-6">
							<div class="toggleCheck chk3 d-inline">
								<input type="checkbox" name="permission[]" id="customers"  value="admin.users">
								<label for="customers">
									<div class="toggleCheck_switch" data-checked="Yes" data-unchecked="No"></div>
								</label>
							</div>
				...
				<div class="row mt-3">
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input customer-permission" id="user-show" value="admin.user.show">
							<label class="custom-control-label font-18 font-pt" for="user-show">Show</label>
						</div>
					</div>
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input customer-permission" id="user-delete" value="admin.user.delete">
					...
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input customer-permission" id="user-download" value="admin.user.download">
		...
		<div class="col-12 col-lg-4 mb-2">
			<div class="card p-3 rounded-0">
				...
				<div class="row mt-3">
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input report-permission" id="order-report" value="admin.report.order">
							<label class="custom-control-label font-18 font-pt" for="order-report">Order</label>
						</div>
					</div>
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input report-permission" id="sells-report" value="admin.report.sell">
					...
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input report-permission" id="customer-report" value="admin.report.customer">
					...
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input report-permission" id="product-repost" value="admin.report.product">
		...
		<div class="col-12 col-lg-4 mb-2">
			<div class="card p-3 rounded-0">
				...
				<div class="row mt-3">
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input email-permission" id="email-show" admin="admin.email.show">
			...
			<div class="card p-3 rounded-0">
				...
				<div class="permission-title title-border">
					<div class="row">
						<div class="col-12 col-lg-6">
							<div class="toggleCheck chk3 d-inline">
								<input type="checkbox" name="permission[]" id="banners" value="admin.banner">
								<label for="banners">
									<div class="toggleCheck_switch" data-checked="Yes" data-unchecked="No"></div>
								</label>
							</div>
				...
				<div class="row mt-3">
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input banner-permission" id="banner-update" value="admin.banner.update">
			...
			<div class="card p-3 rounded-0">
				...
				<div class="permission-title title-border">
					<div class="row">
						<div class="col-12 col-lg-6">
							<div class="toggleCheck chk3 d-inline">
								<input type="checkbox" name="permission[]" id="datas"  value="admin.data">
								<label for="datas">
									<div class="toggleCheck_switch" data-checked="Yes" data-unchecked="No"></div>
								</label>
							</div>
				...
				<div class="row mt-3">
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input data-permission" id="data-sells" value="admin.data.sells,admin.data.sells.download">
							<label class="custom-control-label font-18 font-pt" for="data-sells">Sells</label>
						</div>
					</div>
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input data-permission" id="data-products" value="admin.data.products,admin.data.products.download">
					...
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input data-permission" id="data-order" value="admin.data.orders,admin.data.orders.download">
		...
		<div class="col-12 col-lg-4 mb-2">
			<div class="card p-3 rounded-0">
				...
				<div class="row mt-3">
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input setting-permission" id="website-sttings" value="admin.settings.website">
							<label class="custom-control-label font-18 font-pt" for="website-sttings">Website Settings</label>
						</div>
					</div>
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input setting-permission" id="ecommerce-settings" value="admin.settings.ecommerce" >
					...
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input setting-permission" id="ecpmmerce-payment" value="admin.ecommerce.payment">
					...
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input setting-permission" id="home-page-settings" value="admin.settings.homepage">
					...
					<div class="col-6 mb-2">
						<div class="custom-control custom-checkbox mr-sm-2">
							<input type="checkbox" name="permission[]" class="custom-control-input setting-permission" id="email-settings" value="admin.settings.email">
